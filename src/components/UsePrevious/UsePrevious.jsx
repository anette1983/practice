...
const PreviousCount = () => {
  ...
  // на каждом рендере хук usePrevious возвращает значение value, которое было сохранено в ref.current до того, как useEffect успел обновить его на текущее значение value.
