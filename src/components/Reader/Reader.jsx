...
export class Reader extends Component {
  ...
  // можем заменить два повторяющихся метода одним общим, в который будем передавать разный аргумент (во втором случае отрицательный) и это даст нужный резтат, тк +- 1 = -1
  changeIndex = value => {
